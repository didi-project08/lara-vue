                ...
                <div class="search-result__content">
                    ...
                    <div class="mb-5">
                        <a href="" class="flex items-center mt-2">
                            ...
                            <div class="ml-3">Jhon Doe</div>
                            <div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">jhondoe@gmail.com</div>
                        </a>
                    </div>
                    ...
                    <div class="cursor-pointer relative flex items-center mt-5">
                        ...
                        <div class="ml-2 overflow-hidden">
                            <div class="flex items-center">
                                <a href="javascript:;" class="font-medium truncate mr-5">Jhon Doe</a>
                                <div class="text-xs text-slate-400 ml-auto whitespace-nowrap">12.00 AM</div>
                            </div>
                            <div class="w-full truncate text-slate-500 mt-0.5">Lorem ipsum dolor sit amet</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="intro-x dropdown w-8 h-8">
            ...
            <div class="dropdown-menu w-56">
                <ul class="dropdown-content bg-primary text-white">
                    <li class="p-2">
                        <div class="font-medium">Jhon Doe</div>
                        <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">IT</div>
                    </li>
